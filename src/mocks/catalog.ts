...
export const mockOffers: Offer[] = [
  ...
  { id: 'oferta-1008', name: 'Estrogonofe de frango', description: 'Refeição individual disponível para venda.', basePrice: 29, active: true, requiresMenuChoice: false, components: [], choiceGroups: [], allowedAddonIds: [] }
]
